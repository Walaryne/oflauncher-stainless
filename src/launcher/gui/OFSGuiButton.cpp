...
OFSGuiButton::OFSGuiButton(const std::string &name, resData fontData, SDL_Renderer *renderer, GuiActs actToLink,
	...
	_finishLoading2(spriteSurface_d, spriteSurface_h, spriteSurface_c, textSurface, x, y, shadow);
}
...
OFSGuiButton::OFSGuiButton(const std::string &name, const EmbedData imgData, SDL_Renderer *renderer, GuiActs actToLink, const int &x, const int &y, const ButtonTypes &buttonType)
	...
	//_finishLoading(spriteSurface, textSurface, x, y);
	_finishLoading2(spriteSurface_d, spriteSurface_h, spriteSurface_c, textSurface, x, y, false);
}
...
void OFSGuiButton::_finishLoading2(SDL_Surface *spriteSurface_d, SDL_Surface *spriteSurface_h, SDL_Surface *spriteSurface_c, SDL_Surface *textSurface, const int &x, const int &y, const bool &shadow) {
